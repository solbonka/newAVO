                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-size" id="name" name="name" value="{{ old('name') }}" required>
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control input-size" id="email" name="email" value="{{ old('email') }}" required>
                                @error('email')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
